...
namespace ITTicketingKiosk
{
    ...
    public enum StatusMessageKey
    {
        ...
        CredentialsSaved,
        ReinitializingAPIs,
        TestingPowerSchoolCredentials,
        PowerSchoolCredentialsValid,
        TestingNinjaOneCredentials,
        NinjaOneCredentialsValid,
    ...
    public static class MessageService
    {
        ...
        public static (string Message, StatusType Type) GetStatusMessage(StatusMessageKey key)
        {
            return key switch
            {
                ...
                StatusMessageKey.TestingPowerSchoolCredentials => ("Testing PowerSchool credentials...", StatusType.Info),
                StatusMessageKey.PowerSchoolCredentialsValid => ("PowerSchool credentials validated successfully", StatusType.Success),
                StatusMessageKey.TestingNinjaOneCredentials => ("Testing NinjaOne credentials...", StatusType.Info),
                StatusMessageKey.NinjaOneCredentialsValid => ("NinjaOne credentials validated successfully", StatusType.Success),
